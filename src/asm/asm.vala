public interface Fossil.Asm.ObjectProvider : Object {
	public abstract void foreach_asm_object(HFunc<string,Fossil.Asm.AsmObject> cb); // iterates over all functions this object provides
	public abstract Fossil.Asm.AsmObject? get_asm_object(string name);
}

public interface Fossil.Asm.AsmObject : Object{
	...
	public abstract Fossil.Asm.Scriptreturn? exec(string method, string arg, Object? context = null);
...
public class Fossil.Asm.Scriptreturn : Object {
...
public class Fossil.Asm.Scriptrunner : Object {
	public Fossil.Asm.ObjectProvider object_provider;
	public Fossil.Asm.AsmObject? default_object = null;
	
	public Scriptrunner(Fossil.Asm.ObjectProvider object_provider, Fossil.Asm.AsmObject? default_object = null){
	...
	//#[<comment>]
	public Fossil.Asm.Scriptreturn? exec_line(string _line, Object? context = null){
		...
		Fossil.Asm.AsmObject? object = null;
		...
		if (object_and_func.length != 2){
			if (default_object != null){
				...
				var returnvalue = new Fossil.Asm.Scriptreturn(false,"No object specified!","asm.error.missing_object");
			...
			if (object == null){
				var returnvalue = new Fossil.Asm.Scriptreturn(false,@"Object $object_name does not exist!","asm.error.null_object");
				returnvalue.instruction = line;
				return returnvalue;
			}
		}
	...
	public Fossil.Asm.Scriptreturn? exec_script(string script, Object? context = null){
		int linenum = 0;
		Fossil.Asm.Scriptreturn? returnval = null;
...
public delegate Fossil.Asm.Scriptreturn? Fossil.Asm.Function(string arg, Object? context = null);

public class Fossil.Asm.FunctionDescriptor : Object {
	public Fossil.Asm.Function callback = dummy_callback;
	public string name = "";
	public string localizable_helptext = "";
	public string unlocalized_helptext = "";
	
	private static Fossil.Asm.Scriptreturn? dummy_callback(string arg, Object? context){
		return null;
	}
	
	public FunctionDescriptor.empty(){}
	
	public FunctionDescriptor(owned Fossil.Asm.Function callback, string name, string localizable_helptext, string unlocalized_helptext){
