public interface Dragonstone.GtkUi.Interface.View : Gtk.Widget {
	...
	public abstract bool display_resource(Dragonstone.Request request, Dragonstone.GtkUi.Tab tab, bool as_subview);
