public class Fossil.GtkUi.LegacyWidget.InlineSearchPostB64FilePopoverEasterEgg : Gtk.Popover {
	
	private string base64_buffer = "";
	private string base_uri = "";
	private Fossil.GtkUi.LegacyWidget.InlineSearch parent_entry;
	...
	public InlineSearchPostB64FilePopoverEasterEgg(Fossil.GtkUi.LegacyWidget.InlineSearch parent, string uri){
		this.base_uri = uri;
