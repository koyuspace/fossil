public class Fossil.GtkUi.LegacyWidget.RequestArgumentDisplay : Gtk.Box {
	construct {
		this.orientation = Gtk.Orientation.VERTICAL;
		this.spacing = 4;
	}
	
	public RequestArgumentDisplay(Fossil.Request request){
...
public class Fossil.GtkUi.LegacyWidget.RequestArgumentItem : Gtk.Box {
