public class Fossil.Registry.UriAutoprefix : Object {
	...
	public List<Fossil.Util.UriAutoprefixEntry> entrys = new List<Fossil.Util.UriAutoprefixEntry>();
	
	public void add(string prefix, string replacement){
		entrys.append(new Fossil.Util.UriAutoprefixEntry(prefix, replacement));
	}
	...
	public string try_autoprefix(string uri){
		...
		foreach(Fossil.Util.UriAutoprefixEntry entry in entrys){
