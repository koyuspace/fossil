public class Dragonstone.Startup.Gemini.Gtk {
	public static void setup_views(Dragonstone.SuperRegistry super_registry){
		...
		if (view_registry != null){
			view_registry.add_view("gemini.map",() => { return new Dragonstone.GtkUi.View.Geminitext(); });
			view_registry.add_view("gemini.input",() => { return new Dragonstone.GtkUi.View.GeminiInput(); });
			view_registry.add_rule(new Dragonstone.GtkUi.ViewRegistryRule.resource_view("text/gemini","gemini.map"));
			view_registry.add_rule(new Dragonstone.GtkUi.ViewRegistryRule.resource_view("gemini/input","gemini.input"));
		}
	}
}
