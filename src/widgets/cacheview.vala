public class Dragonstone.Widget.CacheView : Gtk.Box {
	...
	*/
	...
	public CacheView(Dragonstone.Store.Cache cache, Dragonstone.Tab tab, Dragonstone.Registry.TranslationRegistry? itranslation){
