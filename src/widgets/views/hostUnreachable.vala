public class Dragonstone.View.HostUnreachable : Gtk.Bin, Dragonstone.IView {
	...
	construct {
		...
		var label = new Gtk.Label("Host not found!"); //TOTRANSLATE
		var sublabel = new Gtk.Label("How about a game of Hide and seek?"); //TOTRANSLATE
		var icon = new Gtk.Image.from_icon_name("find-location-symbolic",Gtk.IconSize.DIALOG);
		icon.icon_size=6;
	...
	public bool displayResource(Dragonstone.Resource resource,Dragonstone.Tab tab){
		if (!(resource.resourcetype == Dragonstone.ResourceType.ERROR_NO_HOST)) {return false;}
	...
	public bool canHandleCurrentResource(){
		if (resource == null){
			...
			return resource.resourcetype == Dragonstone.ResourceType.ERROR_NO_HOST;
		}
	}
