public class Dragonstone.View.Offline : Gtk.Bin, Dragonstone.IView {
	...
	construct {
		...
		var label = new Gtk.Label("Offline"); //TOTRANSLATE
		var sublabel = new Gtk.Label("chirp... chirp... chirp... chirp..."); //TOTRANSLATE
		var icon = new Gtk.Image.from_icon_name("network-offline-symbolic",Gtk.IconSize.DIALOG);
		icon.icon_size=6;
